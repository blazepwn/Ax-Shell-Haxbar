...
BAR_COMPONENTS_VISIBILITY = {
    ...
    "local_ip": _get_config_var("bar_local_ip_visible"),
    "htb_ip": _get_config_var("bar_htb_ip_visible"),
    "target": _get_config_var("bar_target_visible"),
...
OVPN_PATH = _get_config_var("ovpn_path")
LAUNCHER_ICON_PATH = _get_config_var("launcher_icon_path")
